...
router.get("/getsinglecustomer/:slug", usercontroller.getsinglecustomerBySlug);
...
router.get("/blog/:slug", blogController.getsingleblogBySlug);
...
router.get("/sher/:slug", sherController.getsinglesherBySlug);
...
router.get("/shayari/:slug", shayariController.getsingleshayariBySlug);
...
router.get("/prose/:slug", proseController.getsingleproseBySlug);
