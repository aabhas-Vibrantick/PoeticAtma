...
function AddSherImage() {
  ...
  const handleproseData = async (e) => {
    ...
    try {
      const response = await apiServices.addSherImage(formData);
      if (response.data.success) {
        toast.success(response.data.message);
        setTimeout(() => {
          nav("/admin/view-sherImage");
        }, 3000);
      } else {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col article">
              <h2 className="text-dark">Add Sher Image</h2>
