...
function AddProseImage() {
  ...
  const handleproseData = async (e) => {
    ...
    try {
      const response = await apiServices.addProseImage(formData);
      if (response.data.success) {
        toast.success(response.data.message);
        setTimeout(() => {
          nav("/admin/view-proseImage");
        }, 3000);
      } else {
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col article">
              <h2 className="text-dark">Add Prose Image</h2>
