...
export default function PenddingBlogList() {
  ...
  useEffect(() => {
    ...
    apiServices.getallblog().then(data => {
      if (data.data.success) {
        const filteredBlogs = data.data.data.filter((blog) => blog.status === false);
      ...
      if (data.data.success) {
        ...
        apiServices.getallblog().then(updatedData => {
          if (updatedData.data.success) {
            const filteredBlogs = updatedData.data.data.filter((blog) => blog.status === false);
            setAllBlog(filteredBlogs);
