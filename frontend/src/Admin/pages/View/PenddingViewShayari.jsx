...
export default function PenddingShayriList() {
  ...
  useEffect(() => {
    ...
    apiServices.getallshayari().then(data => {
      if (data.data.success) {
        const filteredShayaris = data.data.data.filter((shayari) => shayari.status === false);
      ...
      if (data.data.success) {
        ...
        apiServices.getallshayari().then(updatedData => {
          if (updatedData.data.success) {
            const filteredShayaris = updatedData.data.data.filter((shayari) => shayari.status === false);
        setAllShayari(filteredShayaris);
