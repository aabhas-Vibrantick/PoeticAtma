...
export default function ProseCategoryList() {
  ...
  useEffect(() => {
    setLoading(true);
    apiServices.getall_prose_category()
      .then(data => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      apiServices.delete_prose_data({ _id: id })
        .then(data => {
          if (data.data.success) {
  ...
  const changeStatus = (id, status) => {
    ...
    apiServices.updateProseCategoryStatus({ _id: id, status: upstatus })
      .then(response => {
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="d-flex flex-wrap gap-2">
          <Link to={`/admin/up-prosecategory/${row._id}`}>
            <button
      ...
      <main className="main-container adminbody bg-light py-4">
        <div className="container-fluid col-10">
          <div className="text-center mb-4">
            <h2 className="text-dark fw-bold">Prose Category List</h2>
          ...
          <div className="row align-items-center mb-4">
            ...
            <div className="col-md-6 text-end">
              <CSVLink data={filteredCategory} filename="prose-category-data.csv">
          ...
          <div className="bg-white shadow-sm rounded p-3">
            <DataTable
              title="List of Prose Categories"
              columns={columns}
