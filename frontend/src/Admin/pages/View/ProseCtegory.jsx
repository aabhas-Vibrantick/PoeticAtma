...
export default function ProseCategoryList() {
  ...
  const deleteCategory = (id) => {
    ...
    apiServices.delete_prose_data(data).then(data => {
      if (data.data.success) {
        toast.success(data.data.message);
        apiServices.getall_prose_category().then(updatedData => {
  ...
  const changeStatus = (id, status) => {
    ...
    apiServices.updateProseCategoryStatus(data).then((response) => {
