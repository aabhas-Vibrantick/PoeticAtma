...
export default function ProseImageList() {
  ...
  const changeStatus = (id, status) => {
    ...
    apiServices.updateProseImageStatus({ _id: id, status: upstatus })
      .then(response => {
  ...
  const columns = [
    ...
    { name: 'Category', selector: row => row.Category_id?.Category_name || "N/A", sortable: true, grow: 1 },
    {
      name: 'Status',
  ...
  cell: row => (
    <div className="d-flex gap-2 flex-wrap">
      <button
        ...
        className={`btn btn-sm ${row.status ? 'btn-outline-danger' : 'btn-outline-success'}`}
      ...
      <main className="main-container adminbody bg-light py-4">
        <div className="container-fluid col-10">
          <div className="text-center mb-4">
            <h2 className="text-dark fw-bold">Prose Image List</h2>
          ...
          <div className="row align-items-center mb-4">
            ...
            <div className="col-md-6 text-end">
              <CSVLink data={filteredShers} filename="prose-images.csv">
