...
export default function ProseImageList() {
  ...
  useEffect(() => {
    ...
    apiServices.getallProseImage().then(data => {
  ...
  const changeStatus = (id, status) => {
    ...
    apiServices.updateProseImageStatus(data).then((response) => {
      if (response.data.success) {
        toast.success(response.data.message);
        apiServices.getallProseImage().then(updatedData => {
