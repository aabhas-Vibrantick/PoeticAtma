...
export default function SherImageList() {
  ...
  const changeStatus = (id, status) => {
    ...
    apiServices
      .updateSherImageStatus({ _id: id, status: upstatus })
      .then((response) => {
  ...
  const columns = [
    { name: "SNo.", selector: (_, index) => index + 1, width: "80px" },
      ...
      <main className="main-container adminbody bg-light py-4">
        <div className="container-fluid col-10">
          <div className="text-center mb-4">
            <h2 className="text-dark fw-bold">Sher Image List</h2>
          ...
          <div className="row align-items-center mb-4">
            ...
            <div className="col-md-6 text-end">
              <CSVLink data={filteredShers} filename="sher-images.csv">
