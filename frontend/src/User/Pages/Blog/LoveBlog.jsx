...
export default function LoveBlog() {
  ...
  useEffect(() => {
    ...
    const categoryId = "685e400cf95fcb84f188ab52";
    apiServices
      .getBlogsByCategory({ Category_id: categoryId })
      .then((data) => {
        // // console.log("...........", data)
  ...
  <Link to={`/single-blog/${encodeURIComponent(data?.slug || data?._id)}`}>
    <img
