...
export default function Bestprose() {
  ...
  const performSearch = (query) => {
    const filteredResults = allBest.filter((best) => {
      const fullName = best.title + best.tags + best.prose + best.userId?.name;
            ...
            <div className="row align-items-start">
              <div className="col-lg-8 m-15px-tb">
                <div className="container mb-5">
                  ...
                  {(searchResults.length > 0 ? searchResults : allBest).map(
                    (data, index) => (
                      <article
                        key={data._id || index}
                  ...
                  {searchResults.length === 0 && allBest.length === 0 && (
