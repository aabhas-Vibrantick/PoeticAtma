  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        try {
          ...
          if (isMounted && commentRes.data.success) {
            ...
            const withReplies = await Promise.all(
              base.map(async (c) => {
                const rr = await apiServices.getAllproseReplies({ _id: c._id });
        ...
        // 3) Page view count
        try {
          const vc = await apiServices.prosegetPageViewCount({ postId: proseId });
                ...
                <div className="container mb-5">
                  <article className="card shadow-sm border-0 rounded-3 overflow-hidden">
                    <div className="position-relative">
                      <img
                        src={prose?.Image ? BASE_URL_IMG + prose.Image : '/default_image.jpg'}
                    ...
                    <div className="card-body p-4 p-md-5">
                      ...
                      <div className="d-flex flex-wrap align-items-center mb-4 text-muted">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <span className="fw-bold">{prose?.tags || 'No tags'}</span>
                        </div>
                      </div>
                      <div className="lead mb-4">
                        <div className="prose-content">
                          {prose?.prose && typeof prose.prose === 'string' ? parse(prose.prose) : <p>No content available.</p>}
                        </div>
                      </div>
                            ...
                            <div className="mb-4" key={comment._id}>
                              <div className="d-flex">
                                <img
                                  ...
                                  src={comment?.userId?.Image ? BASE_URL_IMG + comment.userId.Image : '/assets/images/avtar.png'}
                                  alt="avatar"
                                  width="50"
                                  height="50"
                                  onError={(e) => {
                                ...
                                <div className="flex-grow-1">
                                  <div className="d-flex justify-content-between align-items-baseline">
                                    <h6 className="mb-1">
                                      <Link
                                        to={comment?.userId?._id ? `/poets-profile/${comment.userId._id}` : '#'}
                                  ...
                                  {comment.replies && comment.replies.length > 0 && (
                                    <div className="mt-3">
                                      {comment.replies.map((reply) => (
                                        <div className="d-flex mb-3" key={reply._id}>
                                          <img
                                            className="rounded-circle me-3"
                                            src={reply?.userId?.Image ? BASE_URL_IMG + reply.userId.Image : '/assets/images/avtar.png'}
                                            alt="avatar"
                                            width="40"
                                            height="40"
                                            onError={(e) => {
                                          ...
                                          <div className="flex-grow-1">
                                            <h6 className="mb-1 small">
                                              <Link
                                                to={reply?.userId?._id ? `/poets-profile/${reply.userId._id}` : '#'}
                                                className="text-decoration-none text-capitalize"
                                              >
    ...
    <div className="widget-body">
      <div className="media align-items-center">
        <div className="avatar">
          <img
            src={prose?.userId?.Image ? BASE_URL_IMG + prose.userId.Image : "/assets/images/avtar.png"}
        ...
        <div className="media-body">
          <h6 className="text-capitalize">
            <Link
              ...
              to={
                prose?.userId?.slug
                  ? `/poets-profile/${encodeURIComponent(prose.userId.slug)}`
                  : "#"
              }
            >
              {prose?.userId?.name || "Admin"}
        ...
        return (
          <div className="latest-post-aside media" key={item?._id}>
            <div className="lpa-left media-body">
              ...
              <div className="lpa-meta">
                <Link
                  ...
                  to={
                    poetSlug
                      ? `/poets-profile/${encodeURIComponent(poetSlug)}`
                      : "#"
                  }
                >
            ...
            <div className="lpa-right">
              <Link to={`/single-prose/${encodeURIComponent(proseSlug)}`}>
                <img
                  src={item?.Image ? BASE_URL_IMG + item.Image : "/default_image.jpg"}
