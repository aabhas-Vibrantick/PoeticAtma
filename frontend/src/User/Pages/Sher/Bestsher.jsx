...
export default function Bestsher() {
                          ...
                          <div className="vtimeline-content">
                            ...
                            <ul className="post-meta list-inline">
                                  ...
                                  <li className="list-inline-item">
                                    <i className="fa fa-user-circle-o"></i> <Link to={"/poets-profile/" + `${data?.userId?._id}`}  className="text-capitalize mx-1">{data?.userId?.name || "Admin"}</Link>
                                  </li>
                            ...
                            <p>
                              <Link to={"/single-sher/" + `${data?._id}`}>
                                ...
                                {authenticate ? (
                                  <>
                                    <p className="shayaritext"> {parse(data.sher)}</p>
